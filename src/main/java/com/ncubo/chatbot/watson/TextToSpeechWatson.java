...
public class TextToSpeechWatson{
	...
	public static TextToSpeechWatson getInstance()
	{
		if(textToSpeechWatson == null)
		{
			throw new ChatException("No se a inicializado esta clase (TextToSpeechWatson). Debe instanciar esta clase primero.");
		}
		return textToSpeechWatson;
	}
	...
	public String getAudioToURL(String text, boolean esAudioDinamico, String pathToTransferirAlFTP, String fileName, String idCliente)
	{
		...
		String pathFinal = this.pathAudios + idCliente+ "/" + pathToTransferirAlFTP + "/" + nombreDelArchivo;
